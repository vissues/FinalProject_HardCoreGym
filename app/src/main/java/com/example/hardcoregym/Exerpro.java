...
public class Exerpro extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exerpro);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.monday:
                i = new Intent(this,Monday3.class);
                startActivity(i);
                break;

            case R.id.tuesday:
                i = new Intent(this,Tuesday3.class);
                startActivity(i);
                break;

            case R.id.wednesday:
                i = new Intent(this,Wednesday3.class);
                startActivity(i);
                break;

            case R.id.thursday:
                i = new Intent(this, com.example.hardcoregym.Thursday3.class);
                startActivity(i);
                break;

            case R.id.friday:
                i = new Intent(this, com.example.hardcoregym.Friday3.class);
                startActivity(i);
                break;

            case R.id.saturday:
                i = new Intent(this,Saturday3.class);
                startActivity(i);
                break;
        }
    }
